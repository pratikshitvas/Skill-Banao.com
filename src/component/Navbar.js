  ...
  return (
    <div className='flex justify-between items-center mt-5 h-14 max-w-[1240px] mx-auto px-4 text-black  bg-white rounded-full'>
      ...
      <ul className='hidden md:flex'>
        ...
        <li className='p-4 text-[black]'>Login</li>
      </ul>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[white] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[black] m-4'>SkB.com</h1>
          <li className='p-4 border-b border-gray-600 text-[#1E2C53]'>Home</li>
          <li className='p-4 border-b border-gray-600 text-[#1E2C53]'>Company</li>
          <li className='p-4 border-b border-gray-600 text-[#1E2C53]'>Resources</li>
          <li className='p-4 border-b border-gray-600 text-[#1E2C53]'>About</li>
